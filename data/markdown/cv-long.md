...
**Unix | Network | DB Engineer, IT Infrastructure Architect**

<alexey@veksh.in> | +44 (7988) 703948  | <https://github.com/veksh>

# Summary

I am Unix, DB and Network engineer with 25+ years of  experience in medium to large enterprises, with diverse IT background, in multiple roles: from ERP developer to Unix and network engeneer to IT infrastructure team leader for a large (7000 employees) retail company

My key areas of technical expertise are: Linux administration, datacenter virtualization, LANs and network services, enterprise mail and collaboration software, file sharing and Active Directory, infrastructure automation, scripting and programming, system and applications monitoring, relational databases, enterprise storage, high availability and business continuity, site reliability engineering, network monitoring and security.

My current interests are infrastructure automation (Ansible, Terraform), containerization (Docker, k8s), cloud services (AWS, Y.Cloud), DevOps and GitOps (GitHub, GitLab), software development (Go, Ruby), and monitoring (Prometheus, Grafana).

# Skills

## Golang development
- Experience with enterprise technologies like REST and GRPC APIs, Kafka
- ORM and DB interaction with GORM, sqlx, sqlc bun and postgres, sqlite and redis, managing db migrations with Goose and Atlas
- Release management with GitHub Actions, GoReleaser and ko
...
## Virtualisation
- VMware ESXi: management of stand-alone hypervisors with Ansible (<https://github.com/veksh/ansible-esxi>), scripted install on HPE hardware
- VM scripting: Automated VM deployment with shell and ovftool
...
## Recent achievements at (2021-2022):
-
